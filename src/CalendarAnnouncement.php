...
class CalendarAnnouncement extends CalendarDateTime
{
    ...
    private static $table_name = 'CalendarAnnouncement';
    ...
    public function getCMSFields()
    {
        ...
        $this->beforeUpdateCMSFields(function ($f) use ($self) {
            ...
            $f->insertBefore(new TextField('Title', _t('CalendarAnnouncement.TITLE', 'Title of announcement')),
                "StartDate");
            $f->insertBefore(new TextareaField('Content', _t('CalendarAnnouncement.CONTENT', 'Announcement content')),
                "StartDate");
