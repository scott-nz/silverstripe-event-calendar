    ...
    public function getCMSFields()
    {
        ...
        $this->beforeUpdateCMSFields(function (FieldList $f) use ($self) {
            ...
            $f->addFieldsToTab("Root.$recursion", array(
                CheckboxField::create('Recursion',
                    _t('CalendarEvent.REPEATEVENT', 'Repeat this event'))->addExtraClass('recursion'),
            ...
            $f->addFieldsToTab("Root.$recursion", array(
                OptionsetField::create('MonthlyRecursionType1', '',
                    array('1' => _t('CalendarEvent.ONTHESEDATES', 'On these date(s)...')))->setHasEmptyDefault(true),
                CheckboxSetField::create('RecurringDaysOfMonth', '',
                    DataList::create(RecurringDayOfMonth::class)->map("ID", "Value")),
                OptionsetField::create('MonthlyRecursionType2', '',
                    array('1' => _t('CalendarEvent.ONTHE', 'On the...')))->setHasEmptyDefault(true)
            ));
            ...
            $f->addFieldToTab("Root.$recursion", $monthlyIndex = FieldGroup::create(
                ...
                DropdownField::create('MonthlyDayOfWeek', '',
                    DataList::create(RecurringDayOfWeek::class)->map('Value', 'Title'))->setHasEmptyDefault(true),
